...
| [SetomaticRETL2_TASKLIST.xlsx](SetomaticRETL2_TASKLIST.xlsx) | Sprint task tracker (status, owners: Monish P / Shivansh); STATUS column color-coded: green=Done, amber=In Progress, gray=Not Started, red=Blocked, blue=Deferred |
